    ...
    assert report.as_dict() == {
         ...
         "metadata": [{"directory_path": "C:\\windows\\temp\\1\\log",
                      ...
                      {"tags": set(),
                       "type": "email_address",
                       "value": "email@bad.com"},
                      {"tags": set(), "type": "event", "value": "MicrosoftExist"},
                      {"tags": set(),
                       "type": "uuid",
                       "value": "654e5cff-817c-4e3d-8b01-47a6f45ae09a"},
                      {"tags": set(), "type": "injection_process", "value": "svchost"},
                      {"tags": set(), "type": "interval", "value": 3.0},
                      {"algorithm": "rc4",
                       "iv": None,
                       "key": b"myrc4key",
                       "mode": None,
                      ...
                      {"tags": set(), "type": "mutex", "value": "ithinkimalonenow"},
                      {"key": "keylogger",
                       "tags": set(),
                       "type": "other",
                       "value": "True"},
                      {"tags": set(), "type": "pipe", "value": "\\.\\pipe\\namedpipe"},
                      {"data": "c:\\update.exe",
                      ...
                      {"tags": set(), "type": "version", "value": "3.1"},
                      {"data": None,
                        "description": "Extracted backdoor Foo config file",
                        "file_path": None,
