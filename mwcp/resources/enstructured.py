...
import warnings
warnings.warn(
    'The enstructured library has been deprecated and will be removed in the next release. '
    'Please use construct instead.',
    DeprecationWarning
)
...
def html_hex(data, members, depth=1, colors=COLORPALLETTE, title="Enstructured Hex Output"):
    ...
    for name in ordered_member_names(members):
        ...
        if isinstance(display_value, str) or isinstance(display_value, numbers.Number):
